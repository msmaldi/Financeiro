...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Msmaldi.Financeiro.Website.Entities.CryptoCurrency", b =>
                {
            ...
            modelBuilder.Entity("Msmaldi.Financeiro.Website.Entities.CryptoCurrencyLastTicker", b =>
                {
                    b.Property<string>("CriptoCurrencyId");
                    ...
                    b.HasKey("CriptoCurrencyId");

                    b.ToTable("CryptoCurrencyLastTickers");
                });

            modelBuilder.Entity("Msmaldi.Financeiro.Website.Entities.CryptoWallet", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Msmaldi.Financeiro.Website.Entities.CryptoCurrencyLastTicker", b =>
                {
                    b.HasOne("Msmaldi.Financeiro.Website.Entities.CryptoCurrency", "CriptoCurrency")
                        .WithOne("LastTicker")
                        .HasForeignKey("Msmaldi.Financeiro.Website.Entities.CryptoCurrencyLastTicker", "CriptoCurrencyId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Msmaldi.Financeiro.Website.Entities.CryptoWallet", b =>
                {
                    b.HasOne("Msmaldi.Financeiro.Website.Entities.CryptoCurrency", "CriptoCurrency")
                        .WithMany()
                        .HasForeignKey("CriptoCurrencyId");
